...
<p align="center">
  <img src="https://raw.githubusercontent.com/hmzainjamil/claude-thermal-optimizer/main/banner.png" width="100%" />
</p>

<p align="center">
  <a href="https://github.com/hmzainjamil/claude-thermal-optimizer/stargazers"><img src="https://img.shields.io/github/stars/hmzainjamil/claude-thermal-optimizer?style=for-the-badge&color=FFD700&labelColor=000" alt="Stars"/></a>
  <a href="https://github.com/hmzainjamil/claude-thermal-optimizer/forks"><img src="https://img.shields.io/github/forks/hmzainjamil/claude-thermal-optimizer?style=for-the-badge&color=4FC3F7&labelColor=000" alt="Forks"/></a>
  <a href="https://github.com/hmzainjamil/claude-thermal-optimizer/issues"><img src="https://img.shields.io/github/issues/hmzainjamil/claude-thermal-optimizer?style=for-the-badge&color=FF6B6B&labelColor=000" alt="Issues"/></a>
  <a href="https://github.com/hmzainjamil/claude-thermal-optimizer/pulls"><img src="https://img.shields.io/github/issues-pr/hmzainjamil/claude-thermal-optimizer?style=for-the-badge&color=A8E6CF&labelColor=000" alt="PRs"/></a>
  <a href="https://github.com/hmzainjamil/claude-thermal-optimizer/commits/main"><img src="https://img.shields.io/github/commit-activity/m/hmzainjamil/claude-thermal-optimizer?style=for-the-badge&color=DDA0DD&labelColor=000" alt="Commits"/></a>
  <a href="https://github.com/hmzainjamil/claude-thermal-optimizer/commits/main"><img src="https://img.shields.io/github/last-commit/hmzainjamil/claude-thermal-optimizer?style=for-the-badge&color=98FB98&labelColor=000" alt="Last Commit"/></a>
</p>

<p align="center">
  <img src="https://img.shields.io/badge/Stack-Python_%C2%B7_Shell_%C2%B7_macOS_APIs-blue?style=flat&labelColor=555" />
  <img src="https://img.shields.io/badge/Platform-macOS-blue?style=flat&labelColor=555" />
  <img src="https://img.shields.io/badge/Ollama-Protected-green?style=flat&labelColor=555" />
...
Running the full HMZ AI System simultaneously — 55+ LLM API calls via G0DM0D3, 4 parallel Claude Code sessions, Ollama local models (7B-70B), MAE task swarms, TCC parallel blast operations, and 8+ LaunchAgents in background — generates significant and sustained thermal load on a MacBook Pro. Without active management, CPU throttles under sustained load, performance degrades by 40-60%, and sessions become sluggish. This optimizer handles it silently and automatically.

The system monitors CPU temperature via IOKit SMC sensor polling every 30 seconds, identifies the top CPU consumers via ps-based profiling, clears macOS memory caches (unified memory pressure, VM compressor, purgeable memory) on a configurable schedule, adjusts process priorities via nice/renice for non-critical background processes, and sends native macOS notifications when any thermal threshold is exceeded.

Critically: Ollama is permanently protected and must never be killed under any circumstance, including severe thermal pressure (per CLAUDE.md rule: Never kill Ollama). The Ollama watchdog monitors the process every 15 seconds and restarts it within 30 seconds if it dies from OOM, crash, or any other cause — because G0DM0D3, MAE, and TCC all depend on Ollama being always available for Tier 0 local model routing. No Macs Fan Control integration is used — the optimizer works entirely via silent system APIs, never triggering popup notifications that would disrupt workflow.
...
| | What you get |
|---|---|
| **CPU Monitoring** | IOKit SMC sensor polling every 30 seconds for thermal state |
| **Cache Clearing** | Unified memory, VM compressor, purgeable cache on configurable schedule |
| **Process Prioritization** | nice/renice adjustments for non-critical background processes |
| **Ollama Watchdog** | Monitors every 15s; restarts within 30s if Ollama dies for any reason |
| **Thermal Alerts** | macOS native notifications at configurable temperature thresholds |
| **IOKit Native** | Direct macOS SMC temperature access; no third-party monitoring tools |
| **No MFC Policy** | Macs Fan Control never used; zero popup automation per HMZ policy |
| **Silent Operation** | All thermal management via system APIs with no visible UI disruption |
| **Threshold Config** | Per-machine temperature thresholds for warning and critical levels |
| **Thermal Logging** | All thermal events logged to ~/.claude/tcc-logs/thermal/ for analysis |
